...
void disp_current_weather(current_weather_data_t *data);
void disp_hourly_weather(hourly_weather_data_t *data);
void disp_daily_weather(daily_weather_data_t *data);
